...
const excludeEditColumnTables = ['tblTS', 'MVaRMain', 'EADMain', 'sortedLossesMain', 'sortedLossesIssuerMain', 'CVaRMain'];
// Exclude if the table name starts with "Port" or is in the excludeEditColumnTables array
const includeEditColumn = selectedTableName && !selectedTableName.startsWith('Port') && !excludeEditColumnTables.includes(selectedTableName);

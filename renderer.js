...
document.addEventListener('DOMContentLoaded', () => {
  ...
  setupDropdown({
    ...
    setSelectedDealsTableName: appState.setSelectedDealsTableName.bind(appState)
  });
  ...
  setupDropdown({
    ...
    setSelectedDealsTableName: appState.setSelectedPortTableName.bind(appState),
...
window.api.receive('py-fairValue-complete', (data) => {
  if (data.projectName === 'py-fairValue') {
    ...
    console.log('selectedTableName:', selectedTableName );
      ...
      appState.setActiveElementId('portDataContainer');

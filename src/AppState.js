import { initCurveSelectorGlobal } from "./renderer/MARKET_DATA/INTEREST_RATES/initCurveSelectorGlobal.js";
import { handleIssuerData } from './renderer/NEW_PRODUCTS/ISSUER.js';
import { handleProdData } from './renderer/NEW_PRODUCTS/PROD.js';
import { handleDealsData } from './renderer/CREATE_PORTFOLIO/DEALS.js';
import { handleIRSensData } from './renderer/ANALYSE_PORTFOLIO/MARKET_RISK/IRSens.js';
import { handleCSSensData } from './renderer/ANALYSE_PORTFOLIO/MARKET_RISK/CSSens.js';
...
getRankData() {
  return this.rankData;
    ...
    //     // 1) Dropdown selections auf ALL zurÃ¼cksetzen
    //     Object.values(cfg.dropdownConfig).forEach((d) => {
    //         if (!d) return;
    //         d.selection = ['ALL']; // <- dein Standard
    //     });

    //     // 2) Optional: filtersConfig Sets ebenfalls auf ALL zurÃ¼cksetzen (falls du die wirklich nutzt)

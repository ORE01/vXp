...
if (isDevelopmentEnvironment()) {
  ...
  dbPath = 'C:/Users/Ronald/electron_app/files/UNI.db';
...
function startPythonScriptWithEvent(event, scriptIdentifier, eventType, args = []) {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (isDevelopmentEnvironment()) {
      ...
      // pythonExecutable = 'C:\\Users\\Ronald\\PycharmProjects\\Risk\\venv\\Scripts\\python.exe';
      pythonExecutable = 'C:\\Python312\\python.exe';
      pythonArgs.unshift('C:/Users/Ronald/PycharmProjects/Risk/main.py');
    } else {

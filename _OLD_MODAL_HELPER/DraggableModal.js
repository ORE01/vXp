...
//   const dragElement = modalContent; // nur modal-content ist draggable
//   let isDragging = false;
//   let offsetX = 0;
//   let offsetY = 0;

//   dragElement.onmousedown = (e) => {
//     // console.log('🟢 drag mousedown', e.target); // kurz zum Testen
...
//     // Aktuelle Bildschirmposition "einfrieren"
//     modalContent.style.position = 'fixed';
//     modalContent.style.left = `${rect.left}px`;
//     modalContent.style.top = `${rect.top}px`;
//     modalContent.style.transform = 'none'; // z.B. translate(-50%, -50%) entfernen

//     // Offset relativ zur Klickposition

...
// // Wenn Tabelle bereits existiert → Nutzer fragen
// if (importResult.tableExists) {
//   const overwrite = confirm(
//     `⚠️ Eine Tabelle mit dem Namen "${importResult.tempTableName}" existiert bereits.\n\n` +
//     `Möchtest du die alte Tabelle löschen und durch die neue ersetzen?`
//   );

//   if (!overwrite) {
//     alert("📂 Bestehende Tabelle wird weiterverwendet.");
//     // Du kannst optional hier gleich mit showMatchingUI(...) weitermachen:
...
//   // Tabelle wirklich neu importieren

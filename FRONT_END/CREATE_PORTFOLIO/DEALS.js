...
//   // ✅ NEW: allow orchestrator to force the container
...
//   // ✅ NEW: optionally disable dropdown restore when called from orchestrator
...
//   // ✅ Kontext kommt vom Orchestrator (oder default = deals)
...
//   // ✅ Dropdown-Handling: nur wenn wirklich gewünscht
...
//   // Spiegel-Render nur für Deals (nicht Offers)
//   if (!isOffer) {
//     const mirrorContainer = document.getElementById('newPortfolioDealsDataContainer');
//     if (mirrorContainer) {
//       mirrorContainer.innerHTML = processData(filteredDealsData, tableName);
...
/* =========================================================
   ...
   (isoliert, damit wir hier gezielt debuggen können)
   ========================================================= */
function preserveAndRestoreFilterDropdown({ dropdownId, enabled = true } = {}) {
  ...
  return {
    restore() {
      ...
      // If you get loops, we’ll gate it with a "silent" flag.

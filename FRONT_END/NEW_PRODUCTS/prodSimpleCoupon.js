    ...
    import { createDropdown } from '../../MODAL_HELPER/HandleInputFields.js'
...
export function handleProdAllFields(fieldName, rowData, formRow, label) {
  ...
  //console.log('FIELD', fieldName, '→ section', couponSection);
...
case 'FINLIB': {
  ...
  // Wenn in rowData nichts oder etwas Ungültiges steht → auf 'ql' fallen
...
case 'MODEL': {
  ...
  // rowData.MODEL nur übernehmen, wenn es zu den Options passt
  const initialModel =

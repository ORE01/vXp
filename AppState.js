...
export class AppState {
    constructor() {
        ...
        this.tableConfigs = {
            ...
            //  },
            // comp2: {
            //     dropdownConfig: this.dropdownConfig.comp2,
    ...
    setSelectedPortTableName2(tableName) {
        this.currentPortDataTable2 = tableName;
        // Optionally, you might want to notify observers about this change
        this.notifyObservers();
    }
    getSelectedPortTableName2() {
        return this.currentPortDataTable2;
    }
    ...
    getCreatedPortData2() {
        console.log('getCreatedPortData2:', this.availablePortTablesArray2);
    ...
    updatePortDataTable2(receivedData) {
        ...
        this.updateDropdowns('port');
        // this.updateDropdowns('portTables2');
    }
    ...
    updateMvarDataTable2(receivedData) {
        console.log('updateMvarDataTable2', receivedData);

        this.setMvarData2(receivedData);
